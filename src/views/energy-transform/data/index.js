...
export const optionData = [
  {
    name: '制造业项目数',
    key: 'zzy_project',
    data: [{ value: 0, name: '莲都区' }, { value: 0, name: '开发区' }, { value: 0, name: '青田县' },
      { value: 0, name: '缙云县' }, { value: 0, name: '遂昌县' }, { value: 0, name: '松阳县' },
      { value: 0, name: '云和县' }, { value: 0, name: '庆元县' }, { value: 0, name: '景宁县' }, { value: 0, name: '龙泉市' }]
  },
  {
    name: '制造业项目投资额',
