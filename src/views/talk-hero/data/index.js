...
export const RDexpenditureProportion = {
  ...
  total: 26.76,
  value: [
    // { area: '景宁县', value: 4.87, rate: 18.19880419 },
    // { area: '遂昌县', value: 3.54, rate: 13.22869955 },
    // { area: '龙泉市', value: 2.95, rate: 11.02391629 },
    // { area: '青田县', value: 2.95, rate: 11.02391629 },
    // { area: '开发区', value: 2.92, rate: 10.91180867 },
    // { area: '松阳县', value: 2.6, rate: 9.715994021 },
    // { area: '莲都区', value: 2.36, rate: 8.819133034 },
    // { area: '庆元县', value: 2.25, rate: 8.408071749 },
    // { area: '缙云县', value: 1.28, rate: 4.783258595 },
    // { area: '云和县', value: 1.04, rate: 3.886397608 }
  ]
};
// 全员劳动生产率（万元/人*年）
export const AllPlayProduceRmbData = {
  ...
  total: 165.36,
  value: [
    // { area: '云和县', value: 23.79 },
    // { area: '莲都区', value: 19.6 },
    // { area: '缙云县', value: 19.28 },
    // { area: '庆元县', value: 19.07 },
    // { area: '开发区', value: 16.19 },
    // { area: '青田县', value: 16.14 },
    // { area: '松阳县', value: 15.47 },
    // { area: '龙泉市', value: 13.8 },
    // { area: '景宁县', value: 12.48 },
    // { area: '遂昌县', value: 9.54 }
  ]
};
// 区县各指标排名指标
